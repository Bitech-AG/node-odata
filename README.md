...
@bitech-ag/nota is a fork of [node-odata](https://github.com/zackyang000/node-odata)
...
@bitech-ag/nota is currently at an beta stage, it is stable but not 100% feature complete. 
@bitech-ag/nota is written by ECMAScript 6 then compiled by [babel](https://babeljs.io/).
...
@bitech-ag/nota is licensed under the MIT license. See [LICENSE](LICENSE) for more information.
